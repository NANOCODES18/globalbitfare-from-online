...
class Userdashcontroller extends Controller
{
    ...
    public function userdashb()
    {
        ...
        $user_all_investment = Investment::where('userid', $this->logged_in_user()->id)->get();
        ...
        $data['usercurrentinvestemt'] = $usercurrentinvestemt;
        $data['userallinvestemt'] = $userallinvestemt;
    ...
    public function userdashb_referrals()
    {
        ...
        $myref = Referral::where('newuser', $this->logged_in_user()->id);
        if ($myref->count()>0) {
            # code...
            $refname = User::where("id", $myref->olduseruserid)->first()->name;
    ...
    public function   userdashb_deposit_request(Request $req)
    {
        ...
        if ($result) {
            ...
            $username =$user->name;
            $mail = "The user $username has requested to make a deposit of $deposit_amount USD to the $method  account $methacc";
    ...
    public function transactionhistory (){
        ...
        $data['withdrawals'] = $user_withdrawals;
        $data['user_deposits'] = $user_deposits;
        return view('dashb.transactionhistory', $data);

    }

    function assets_and_exchange (){
        $user_funds = Fund::where('userid', $this->logged_in_user()->id)->first();
        $data['funds'] = $user_funds;
        return view('dashb.assets_and_exchange', $data);
