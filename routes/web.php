...
Route::get ('/assets_and_exchange', [App\Http\Controllers\Userdashcontroller::class, 'assets_and_exchange'])->name('assets_and_exchange');
Route::get ('/transactionhistory', [App\Http\Controllers\Userdashcontroller::class, 'transactionhistory'])->name('transactionhistory');
...
Route::get('/visref', [App\Http\Controllers\VisitorController::class, 'visref'])->name('visref');
