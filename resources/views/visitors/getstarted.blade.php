...
<div class="banner-area center">
    <div class="area">
        <div class="bodycontainer">
            ...
            <div  style="margin: 20px 0;">
                <a href="{{route('index')}}">HOME</a> / GET STARTED
            </div>
        </div>
    ...
    <br><br>
    <div class="margintb">
        <a href="https://blockchain.info/"><img src="images/blockchain.png"></a>
    </div>
    <div class="margintb">
        <a href="https://www.coinbase.com/"><img src="images/coinbase.png"></a>
    </div>
    <br><br>
