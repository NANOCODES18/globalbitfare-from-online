    ...
    <div class="main-panel bg-light">
        <div class="content bg-light">
            <div class="page-inner">
                <div class="mt-2 mb-4">
                    <h1 class="title1 text-dark">Current Running Investments</h1>
                </div>
                <div>
                </div>
                <div>
                           ...
                           <tbody>
                               ...
                               <tr>
                                  ...
                                  <div class="alert alert-danger alert-dismissable">
                                    ...
                                    <i class="fa fa-info-circle"></i> You do not have a package at the moment
                                </div>
                                        ...
                                        @if ($my_current_investments->count() > 0)
                                            @foreach ($my_current_investments as $my_investment)
                                                <tr>
                                                    <td class="text-center">{{ $loop->index + 1 }}</td>
                                                    <td><a href="#"
                                                            class="text-yellow hover-warning">{{ $my_investment->investmentplan }}</a>
                                                    </td>
                                        ...
                                        @else
                                            <tr>
                                                ...
                                                <td colspan="5" class="text-center"><a href="#"
                                                        class="text-yellow hover-warning">You have no current running
                                                        Investment</a></td>
