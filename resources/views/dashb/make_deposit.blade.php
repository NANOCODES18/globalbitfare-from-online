                                        ...
                                        <div class="col-lg-6 col-12">
                                            <div class="box bg-info box-solid">
                                                ...
                                                <div class="box-content">
                                                    <div class="box-body">
                                                        <form action="{{ route('userdashb_deposit_request') }}"
                                                            method="post">
                                                            @csrf
                                                            <div class="form-group row">
                                                                <label class="col-12" for="login1-username">select
                                                                    method</label>
                                                                <div class="col-12">
                                                                    <select required name="method" id=""
                                                                        class="form-control">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-12" for="lock1-password1">Amount
                                                                    (in {{$currency}})</label>
                                                                <div class="col-12">
                                                                    <input type="number" required class="form-control"
                                                                        id="lock1-password1" name="amount"
                                                            ...
                                                            <div class="form-group row mb-0">
                                                                <div class="col-12">
                                                                    <button type="submit" class="btn btn-success">
                                                                        <i class="fa fa-arrow-right mr-5"></i> Proceed with
                                                                        deposit
                                                                    </button>
                                                                </div>
                                                            </div>
