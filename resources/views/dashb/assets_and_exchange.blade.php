...
@section('dashbody')
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="p-3 card bg-light shadow">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-1 text-dark"><b>${{$funds? $funds->balance:0}}</b></h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <form method="POST" action="javascript:void(0)" id="exchnageform">
                                <input type="hidden" name="_token" value="DtPT5ws6g6qtmDL1zs7dZecZ31wBLvYFS1MwBR03">                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  class="form-control text-dark bg-light" placeholder="Quantity of usd" id="quantity">
                                </div>
    ...
    function getQuantity(){
        let uurl = "#" + '/' + sourceasset.value  + '/' + destinationasset.value+ '/' + amount.value;
        $.ajax({
            url: uurl,
            type: 'GET',
    ...
    $('#exchnageform').on('submit', function(event) {
        ...
        if (amount.value == '') {
            ...
            $.ajax({
                url: "https://pggg.xwayminage.com/dashboard/exchange",
                type: 'POST',
